...
export default function Home() {
    ...
    return (
        <main className="min-h-screen w-full h-full">
            ...
            <section className="relative w-full justify-center bg-black bg-opacity-40 text-white text-center">
                <h1 className="text-6xl text-white regular-text lg:leading-snug pt-4">...lets &#123;code&#125;</h1>
            </section>
            <section className="relative w-full justify-center bg-black bg-opacity-40 text-white text-center pt-6">
                ...
                <div className="grid md:grid-cols-auto lg:grid-cols-auto pt-6 text-center">
                    ...
                    <span className="pt-4 pb-4 h-full">
                        <Link to="/post">
                                See All
                        </Link>
                    </span>
